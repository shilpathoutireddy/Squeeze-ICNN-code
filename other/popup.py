...
def Popup(*args, title=None, button_color=None, background_color=None, text_color=None, button_type=POPUP_BUTTONS_OK, auto_close=False,
    ...
    if custom_text != (None, None):
        ...
        window.AddRow(PopupButton('Full analysis + Plots', button_color=button_color, focus=True, bind_return_key=True, pad=((20, 5), 3),
                                  size=(25, 1)), PopupButton('Plots from pre evaluated data', button_color=button_color, size=(25, 1)))
